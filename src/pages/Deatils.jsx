...
const Details = () => {
    ...
    return (
        <div>
            ...
            <div className="container  mx-auto py-5 grid-cols-1 lg:grid-cols-2 gap-10">
             ...
             "
                ...
                <div className="flex w-[90vw] mx-auto flex-col gap-3">
                    ...
                    <div className="w-[90vw] mx-auto ">
                        <h1 className="font-bold text-[1.2rem]">Instruction</h1>
                        <div className=" text-[0.8rem] line-height-2">
